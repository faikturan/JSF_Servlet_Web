...
@NamedQueries({
	...
	@NamedQuery(name= "Doktorlar.findByDoktorid", 
	query = "SELECT d FROM Doktorlar d WHERE d.doktorid = :doktorid"),
	@NamedQuery(name= "Doktorlar.findByBransid", 
	query = "SELECT d FROM Doktorlar d WHERE d.bransid = :bransid"),
	@NamedQuery(name= "Doktorlar.findByHastaneid", 
	query = "SELECT d FROM Doktorlar d WHERE d.hastaneid = :hastaneid"),
	@NamedQuery(name= "Doktorlar.findByDoktoradi", 
	query = "SELECT d FROM Doktorlar d WHERE d.doktoradi = :doktoradi"),
	@NamedQuery(name= "Doktorlar.findByBransIdAndHastaneID", 
	query = "SELECT d FROM Doktorlar d WHERE d.bransid = "
			+ ":clinicid AND d.hastaneid=:hospitalid")
	})
public class Doktorlar implements Serializable {
	...
	public boolean equals(Object object) {
		...
		return !((this.doktorid == null && other.doktorid != null) 
				|| (this.doktorid != null && !this.doktorid.equals(other.doktorid)));
	}

	@Override
	public String toString() {
		return "Doktorlar [doktorid=" + doktorid + "]";
	}
